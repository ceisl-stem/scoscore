...
#| column: margin
#| fig-cap: "Big-picture overview of where the highest opportunity exists across the state of Indiana."
...
The following is a density plot of the SCOscores across the state.
...
### Urban-Centric Locales

The following are density plots of the SCOscores by urban-centric locale.
...
density_ucl_plot <- ggdensity(
  ...
  scale_fill_manual(values = ucl_palette) +
  scale_x_continuous(limits = c(0, 2)) +
  geom_vline(
    xintercept = 1,
    linetype = 3,
